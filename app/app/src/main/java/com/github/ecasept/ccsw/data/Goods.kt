...
private val goods = listOf(
    ...
    Good("Bank", "Sugar", "SUG", R.drawable.good_06),
    Good("Temple", "Nuts", "NUT", R.drawable.good_07),
    Good("Wizard tower", "Salt", "SLT", R.drawable.good_08),
    Good("Shipment", "Vanilla", "VNL", R.drawable.good_09),
    Good("Alchemy lab", "Eggs", "EGG", R.drawable.good_10),
    Good("Portal", "Cinnamon", "CNM", R.drawable.good_11),
    Good("Time machine", "Cream", "CRM", R.drawable.good_03),
    Good("Antimatter condenser", "Jam", "JAM", R.drawable.good_04),
    Good("Prism", "White chocolate", "WCH", R.drawable.good_05),
